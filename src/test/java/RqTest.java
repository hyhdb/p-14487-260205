...
public class RqTest {
    ...
    @Test
    @DisplayName(value = "명령: 목록?page=1 일때, rq.getParam(\"page\") -> 1")
    void t6() {
    ...
    @Test
    @DisplayName(value = "명령: 목록?page=10 일때, rq.getParam(\"page\") -> 1")
    void t7() {
    ...
    @Test
    @DisplayName(value = "명령: 목록?keyword= 일때, rq.getParam(\"keywordType\", \"\") -> \"\"")
    void t11() {
